# Generated by Django 5.1.2 on 2025-04-17 17:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_pedido', models.CharField(choices=[('NOVO', 'NOVO'), ('PENDENTE', 'PENDENTE'), ('ATENDIDO', 'ATENDIDO'), ('FINALIZADO', 'FINALIZADO')], default='NOVO', max_length=10, verbose_name='Status')),
                ('tipo_entulho', models.CharField(max_length=100, verbose_name='Tipo de Entulho')),
