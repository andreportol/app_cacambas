...
from .forms import (
    ResultadoOrcamentoForm,
    ConfirmarPedidoForm,
    AvisoConfirmacaoForm,
    CadastroUsuarioForm,
    TransportadorLoginForm,
    TransportadorForm,
)
from .models import (
    TransportadorProduto,
    Produto,
    Bairros_CG,
    Transportador,
    Regiao_CG,
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                return render(request, 'login_transportador.html', {'form': form})
            ...
            if senha == transportador.senha:
                ...
                if 'bloqueio_inicio' in request.session:
                    del request.session['bloqueio_inicio']
                return redirect('core:editar_dados_transportador')
            else:
...
def editar_dados_transportador(request):
    ...
    if not transportador_id:
        return redirect('login_transportador')
    ...
    return render(request, 'editar_dados_transportador.html', {
        'form': form,
        'transportador': transportador,
    })
